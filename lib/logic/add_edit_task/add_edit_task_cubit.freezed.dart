...
mixin _$AddEditTaskState {
 ...
 String? get id; String get title; Duration get workDuration; Duration get shortBreakDuration; Duration get longBreakDuration; int get maxPomodoroRound; bool get vibrate; Tones get tone; double get toneVolume; double get statusVolume; bool get readStatusAloud;// UI state fields
 bool get isEditing; Object? get error;
/// Create a copy of AddEditTaskState
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$AddEditTaskStateCopyWith<AddEditTaskState> get copyWith => _$AddEditTaskStateCopyWithImpl<AddEditTaskState>(this as AddEditTaskState, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AddEditTaskState&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.workDuration, workDuration) || other.workDuration == workDuration)&&(identical(other.shortBreakDuration, shortBreakDuration) || other.shortBreakDuration == shortBreakDuration)&&(identical(other.longBreakDuration, longBreakDuration) || other.longBreakDuration == longBreakDuration)&&(identical(other.maxPomodoroRound, maxPomodoroRound) || other.maxPomodoroRound == maxPomodoroRound)&&(identical(other.vibrate, vibrate) || other.vibrate == vibrate)&&(identical(other.tone, tone) || other.tone == tone)&&(identical(other.toneVolume, toneVolume) || other.toneVolume == toneVolume)&&(identical(other.statusVolume, statusVolume) || other.statusVolume == statusVolume)&&(identical(other.readStatusAloud, readStatusAloud) || other.readStatusAloud == readStatusAloud)&&(identical(other.isEditing, isEditing) || other.isEditing == isEditing)&&const DeepCollectionEquality().equals(other.error, error));
}


@override
int get hashCode => Object.hash(runtimeType,id,title,workDuration,shortBreakDuration,longBreakDuration,maxPomodoroRound,vibrate,tone,toneVolume,statusVolume,readStatusAloud,isEditing,const DeepCollectionEquality().hash(error));
...
abstract mixin class $AddEditTaskStateCopyWith<$Res>  {
  factory $AddEditTaskStateCopyWith(AddEditTaskState value, $Res Function(AddEditTaskState) _then) = _$AddEditTaskStateCopyWithImpl;
@useResult
$Res call({
 String? id, String title, Duration workDuration, Duration shortBreakDuration, Duration longBreakDuration, int maxPomodoroRound, bool vibrate, Tones tone, double toneVolume, double statusVolume, bool readStatusAloud, bool isEditing, Object? error
});
...
/// Create a copy of AddEditTaskState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? title = null,Object? workDuration = null,Object? shortBreakDuration = null,Object? longBreakDuration = null,Object? maxPomodoroRound = null,Object? vibrate = null,Object? tone = null,Object? toneVolume = null,Object? statusVolume = null,Object? readStatusAloud = null,Object? isEditing = null,Object? error = freezed,}) {
...
class _AddEditTaskState implements AddEditTaskState {
  const _AddEditTaskState({this.id, required this.title, required this.workDuration, required this.shortBreakDuration, required this.longBreakDuration, required this.maxPomodoroRound, required this.vibrate, required this.tone, required this.toneVolume, required this.statusVolume, required this.readStatusAloud, required this.isEditing, this.error});
...
@pragma('vm:prefer-inline')
_$AddEditTaskStateCopyWith<_AddEditTaskState> get copyWith => __$AddEditTaskStateCopyWithImpl<_AddEditTaskState>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _AddEditTaskState&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.workDuration, workDuration) || other.workDuration == workDuration)&&(identical(other.shortBreakDuration, shortBreakDuration) || other.shortBreakDuration == shortBreakDuration)&&(identical(other.longBreakDuration, longBreakDuration) || other.longBreakDuration == longBreakDuration)&&(identical(other.maxPomodoroRound, maxPomodoroRound) || other.maxPomodoroRound == maxPomodoroRound)&&(identical(other.vibrate, vibrate) || other.vibrate == vibrate)&&(identical(other.tone, tone) || other.tone == tone)&&(identical(other.toneVolume, toneVolume) || other.toneVolume == toneVolume)&&(identical(other.statusVolume, statusVolume) || other.statusVolume == statusVolume)&&(identical(other.readStatusAloud, readStatusAloud) || other.readStatusAloud == readStatusAloud)&&(identical(other.isEditing, isEditing) || other.isEditing == isEditing)&&const DeepCollectionEquality().equals(other.error, error));
}
...
/// @nodoc
abstract mixin class _$AddEditTaskStateCopyWith<$Res> implements $AddEditTaskStateCopyWith<$Res> {
  factory _$AddEditTaskStateCopyWith(_AddEditTaskState value, $Res Function(_AddEditTaskState) _then) = __$AddEditTaskStateCopyWithImpl;
@override @useResult
$Res call({
 String? id, String title, Duration workDuration, Duration shortBreakDuration, Duration longBreakDuration, int maxPomodoroRound, bool vibrate, Tones tone, double toneVolume, double statusVolume, bool readStatusAloud, bool isEditing, Object? error
});
