...
AppTexts get englishLocalization => AppTexts(
      ...
      // calendar screen
      calendarScreenDone: 'Done',
      calendarScreenRemain: 'Remain',
...
AppTexts get persianLocalization => AppTexts(
      ...
      tasksScreenNoDoneTasksTitle: 'کار انجام شده ای پیدا نشد!',
      ...
      // calendar screen
      calendarScreenDone: 'انجام شده',
      calendarScreenRemain: 'باقی مانده',
      calendarScreenTitle: 'تقویم',
      calendarScreenEmptyListTitle: 'لیست گزارشات خالی است!',
      calendarScreenEmptyListDescription: 'َشما گزارش ثبت شدهای ندارید.',
      calendarScreenNoRecordedTasksFound: 'ّبرای تاریخ انتخاب شده گزارشی ثبت نشده!',
      calendarScreenError: 'مشکلی پیش امده است.',
