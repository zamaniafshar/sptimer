...
mixin _$TaskReportage {
  ...
  $TaskReportageCopyWith<TaskReportage> get copyWith =>
      _$TaskReportageCopyWithImpl<TaskReportage>(
          this as TaskReportage, _$identity);
  ...
  int get hashCode => Object.hash(
      runtimeType, id, endDate, startDate, taskStatus, taskId, taskTitle);
...
abstract mixin class $TaskReportageCopyWith<$Res> {
  factory $TaskReportageCopyWith(
          TaskReportage value, $Res Function(TaskReportage) _then) =
      _$TaskReportageCopyWithImpl;
  @useResult
  $Res call(
      {String? id,
      DateTime endDate,
...
class _TaskReportage implements TaskReportage {
  ...
  factory _TaskReportage.fromJson(Map<String, dynamic> json) =>
      _$TaskReportageFromJson(json);
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$TaskReportageCopyWith<_TaskReportage> get copyWith =>
      __$TaskReportageCopyWithImpl<_TaskReportage>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$TaskReportageToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$TaskReportageCopyWith<$Res>
    implements $TaskReportageCopyWith<$Res> {
  factory _$TaskReportageCopyWith(
          _TaskReportage value, $Res Function(_TaskReportage) _then) =
      __$TaskReportageCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
