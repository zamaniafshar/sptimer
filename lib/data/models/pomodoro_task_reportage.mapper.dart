...
class PomodoroTaskReportageMapper extends ClassMapperBase<PomodoroTaskReportage> {
  ...
  static const Field<PomodoroTaskReportage, int> _f$id = Field('id', _$id, opt: true);
  ...
  static String _$taskName(PomodoroTaskReportage v) => v.taskTitle;
  static const Field<PomodoroTaskReportage, String> _f$taskName = Field('taskName', _$taskName);
  ...
  static PomodoroTaskReportage _instantiate(DecodingData data) {
    return PomodoroTaskReportage(
        ...
        taskTitle: data.dec(_f$taskName));
  }
...
mixin PomodoroTaskReportageMappable {
  ...
  PomodoroTaskReportageCopyWith<PomodoroTaskReportage, PomodoroTaskReportage, PomodoroTaskReportage>
      get copyWith =>
          _PomodoroTaskReportageCopyWithImpl(this as PomodoroTaskReportage, $identity, $identity);
  @override
  String toString() {
    return PomodoroTaskReportageMapper.ensureInitialized()
  ...
  @override
  int get hashCode {
    return PomodoroTaskReportageMapper.ensureInitialized().hashValue(this as PomodoroTaskReportage);
  }
}

extension PomodoroTaskReportageValueCopy<$R, $Out>
    on ObjectCopyWith<$R, PomodoroTaskReportage, $Out> {
  PomodoroTaskReportageCopyWith<$R, PomodoroTaskReportage, $Out> get $asPomodoroTaskReportage =>
      $base.as((v, t, t2) => _PomodoroTaskReportageCopyWithImpl(v, t, t2));
}

abstract class PomodoroTaskReportageCopyWith<$R, $In extends PomodoroTaskReportage, $Out>
  ...
  $R call(
      ...
      int? pomodoroTaskId,
      String? taskName});
  PomodoroTaskReportageCopyWith<$R2, $In, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t);
}
...
class _PomodoroTaskReportageCopyWithImpl<$R, $Out>
  ...
  PomodoroTaskReportage $make(CopyWithData data) => PomodoroTaskReportage(
      ...
      taskTitle: data.get(#taskName, or: $value.taskTitle));

  @override
  PomodoroTaskReportageCopyWith<$R2, PomodoroTaskReportage, $Out2> $chain<$R2, $Out2>(
          Then<$Out2, $R2> t) =>
