...
_Task _$TaskFromJson(Map<String, dynamic> json) => _Task(
  ...
  workDuration: Duration(microseconds: (json['work_duration'] as num).toInt()),
  shortBreakDuration: Duration(
    microseconds: (json['short_break_duration'] as num).toInt(),
  ),
  longBreakDuration: Duration(
    microseconds: (json['long_break_duration'] as num).toInt(),
  ),
